...
8k. Validate Sprint 20I.3G/H category KPI card enhancements with operators, ensuring format `X (Y tấn)` and ton-based delta values (`▲/▼ X% với tháng trước`) match expectations.
