...
10. Review Sprint 20A Costing Engine with real cost data. The read-only engine now exposes Production Order, Component, and Project material cost summaries using actual issue transaction valuation with weighted average Inventory fallback.
